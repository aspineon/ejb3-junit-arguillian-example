ejb3-junit-arguillian-example: Example Using Multiple Java EE 6 Technologies Deployed as an EAR
==============================================================================================

What is it?
-----------

This is your project! It is a sample, deployable Maven 3 project to help you get your foot in the door developing with Java EE 6 on JBoss Enterprise Application Platform 6 or JBoss AS 7 and junit testing using Arquillian. 
...
Original example taken from the jboss archetype webapp ear
...
4. This will deploy `target/ejb3-junit-arguillian-example.ear` to the running instance of the server.


Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/ejb3-junit-arguillian-example-web>.
...
You should see messages similar to the following:
    ...
    INFO  [com.github.monk8800.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [com.github.monk8800.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/ejb3-junit-arguillian-exampleTestDS]
